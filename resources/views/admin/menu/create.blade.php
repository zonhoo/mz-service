            ...
            <div class="panel-body">
                ...
                {!! Form::open(['route'=>'admin.menu.store','role'=>'form','class'=>'form-horizontal',]) !!}
                    ...
                    <div class="form-group @if($errors->first('fid')) has-error @endif">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" name="fid">
                                ...
                                <option value="{{$menu->id}}">&nbsp;&equiv;{{trans('admin.'.$menu->name)}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group @if($errors->first('name')) has-error @endif">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="name" class="form-control" id="name" placeholder="@if($errors->first('name')) {{$errors->first('name')}} @else 菜单名称 @endif">
                        </div>
                    </div>
                    ...
                    <div class="form-group @if($errors->first('route_name')) has-error @endif">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="route_name" class="form-control" id="route_name" placeholder="@if($errors->first('route_name')) {{$errors->first('route_name')}} @else 路由名 @endif">
                        </div>
                    </div>
                    ...
                    <div class="form-group @if($errors->first('icon')) has-error @endif">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="icon" class="form-control" id="icon" placeholder="@if($errors->first('icon')) {{$errors->first('icon')}} @else 节点图标 @endif">
                        </div>
                    </div>
