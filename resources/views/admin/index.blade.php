    ...
    <div class="col-sm-8">
        ...
        <div class="xe-widget xe-weather">
            <div class="xe-background xe-background-animated">
                {!! Html::image('style/assets/images/clouds.png') !!}
            </div>
            ...
            <div class="xe-body">
                ...
                <ul class="list-unstyled">
                    <li>
                        <div class="xe-comment-entry">
                            <a href="#" class="xe-user-img">
                                {!! Html::image('style/assets/images/user-2.png',null,['class'=>'img-circle','width'=>'40']) !!}
                            </a>
                    ...
                    <li>
                        <div class="xe-comment-entry">
                            <a href="#" class="xe-user-img">
                                {!! Html::image('style/assets/images/user-5.png',null,['class'=>'img-circle','width'=>'40']) !!}
                            </a>
                    ...
                    <li>
                        <div class="xe-comment-entry">
                            <a href="#" class="xe-user-img">
                                {!! Html::image('style/assets/images/user-4.png',null,['class'=>'img-circle','width'=>'40']) !!}
                            </a>
