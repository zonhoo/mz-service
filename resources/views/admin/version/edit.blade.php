 				...
 				<div class="col-sm-12">
 					...
 					<div class="panel panel-default">
 						<div class="panel-heading">
 							<h3 class="panel-title">修改ID为<{{$version->id}}>内容信息</h3>
 						...
 						<div class="panel-body">
 							...
 							{!! Form::open(['route'=>['admin.version.update',$version->id],'role'=>'form','class'=>'form-horizontal','method'=>'patch']) !!}
                                ...
                                <div class="form-group @if($errors->first('version_name')) has-error @endif">
                                    ...
                                    <div class="col-sm-11">
                                        <input type="text" name="version_name" class="form-control" id="version_name" value="{{$version->version_name}}" placeholder="@if($errors->first('version_name')) {{$errors->first('version_name')}} @else 版本名 @endif">
                                    </div>
                                </div>
